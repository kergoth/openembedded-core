...
export CONFIG_SITE=${SDKPATH}/site-config-$multimach_target_sys
export OECORE_NATIVE_SYSROOT="$sdkpathnative"
export OECORE_TARGET_SYSROOT="\$SDKTARGETSYSROOT"
export OECORE_ACLOCAL_OPTS="-I $sdkpathnative/usr/share/aclocal"
export OECORE_BASELIB="${baselib}"
export OECORE_TARGET_ARCH="${TARGET_ARCH}"
export OECORE_TARGET_OS="${TARGET_OS}"
